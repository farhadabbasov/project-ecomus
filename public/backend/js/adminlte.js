...
(function (global, factory) {
    ...
    /**
     * --------------------------------------------
     * @file AdminLTE push-menus.ts
     * @description Push menus for AdminLTE.
     * @license MIT
     * --------------------------------------------
     */
    /**
     ...
     * ------------------------------------------------------------------------
     */
    const DATA_KEY$4 = 'lte.push-menus';
    ...
    const CLASS_NAME_MENU_OPEN$1 = 'menus-open';
    const SELECTOR_APP_SIDEBAR = '.app-sidebar';
    const SELECTOR_SIDEBAR_MENU = '.sidebar-menus';
    ...
    const CLASS_NAME_MENU_OPEN = 'menus-open';
