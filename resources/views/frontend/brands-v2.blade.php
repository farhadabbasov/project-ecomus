                            ...
                            <div class="tf-content-brands">
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/7-chanel.png')}}" alt="">
                                    </a>
                    ...
                    <div class="tf_filter_a tf-filter-item tf-tab-content">
                        <div class="tf-filter-item-inner">
                            ...
                            <div class="tf-content-brands">
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/asos.png')}}" alt="">
                                    </a>
                                    <a href="shop-default.html">Asos</a>
                                </div>
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/armani.png')}}" alt="">
                                    </a>
                                    <a href="#">Armani</a>
                                </div>
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/asics.png')}}" alt="">
                                    </a>
                                    <a href="#">Asics</a>
                                </div>
                            </div>
                    ...
                    <div class="tf_filter_b tf-filter-item tf-tab-content">
                        <div class="tf-filter-item-inner">
                            ...
                            <div class="tf-content-brands">
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/burberry.png')}}" alt="">
                                    </a>
                                    <a href="shop-default.html">Burberry</a>
                                </div>
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/bogner.png')}}" alt="">
                                    </a>
                    ...
                    <div class="tf_filter_c tf-filter-item tf-tab-content">
                        <div class="tf-filter-item-inner">
                            ...
                            <div class="tf-content-brands">
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/christian-dior.png')}}" alt="">
                                    </a>
                                    <a href="shop-default.html">Christian Dior</a>
                                </div>
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/chopard-1-logo.png')}}" alt="">
                                    </a>
                                    <a href="shop-default.html">Chopard</a>
                                </div>
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/cartier-2-logo.png')}}" alt="">
                                    </a>
                                    <a href="shop-default.html">Catier</a>
                                </div>
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/calvin-klein-1-logo.png')}}" alt="">
                                    </a>
                    ...
                    <div class="tf_filter_e tf-filter-item tf-tab-content">
                        <div class="tf-filter-item-inner">
                            ...
                            <div class="tf-content-brands">
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/escada-beaute-logo.png')}}" alt="">
                                    </a>
                    ...
                    <div class="tf_filter_f tf-filter-item tf-tab-content">
                        <div class="tf-filter-item-inner">
                            ...
                            <div class="tf-content-brands">
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/furla-logo-png.png')}}" alt="">
                                    </a>
                                    <a href="shop-default.html">Furla</a>
                                </div>
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/fendi-logo.png')}}" alt="">
                                    </a>
                                    <a href="#">Fendi</a>
                                </div>
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/foot-locker-1.png')}}" alt="">
                                    </a>
                    ...
                    <div class="tf_filter_h tf-filter-item tf-tab-content">
                        <div class="tf-filter-item-inner">
                            ...
                            <div class="tf-content-brands">
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/hugo-boss-logo.png')}}" alt="">
                                    </a>
                                    <a href="shop-default.html">Hugo Boss</a>
                                </div>
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/hermes-logo.png')}}" alt="">
                                    </a>
                                    <a href="#">Hermes</a>
                                </div>
                            </div>
                    ...
                    <div class="tf_filter_i tf-filter-item tf-tab-content">
                        <div class="tf-filter-item-inner">
                            ...
                            <div class="tf-content-brands">
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/iwc-schaffhausen-logo.png')}}" alt="">
                                    </a>
                    ...
                    <div class="tf_filter_j tf-filter-item tf-tab-content">
                        <div class="tf-filter-item-inner">
                            ...
                            <div class="tf-content-brands">
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/jaeger-le-coultre-logo-png.png')}}" alt="">
                                    </a>
                                    <a href="shop-default.html">Jaeger Le Coultre</a>
                                </div>
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/just-cavalli-logo.png')}}" alt="">
                                    </a>
                    ...
                    <div class="tf_filter_l tf-filter-item tf-tab-content">
                        <div class="tf-filter-item-inner">
                            ...
                            <div class="tf-content-brands">
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/longines-1-logo.png')}}" alt="">
                                    </a>
                    ...
                    <div class="tf_filter_n tf-filter-item tf-tab-content">
                        <div class="tf-filter-item-inner">
                            ...
                            <div class="tf-content-brands">
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/nine-west-logo.png')}}" alt="">
                                    </a>
                    ...
                    <div class="tf_filter_o tf-filter-item tf-tab-content">
                        <div class="tf-filter-item-inner">
                            ...
                            <div class="tf-content-brands">
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/old-navy-logo.png')}}" alt="">
                                    </a>
                                    <a href="shop-default.html">Old Navy</a>
                                </div>
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/oakley-1-logo.png')}}" alt="">
                                    </a>
                    ...
                    <div class="tf_filter_p tf-filter-item tf-tab-content">
                        <div class="tf-filter-item-inner">
                            ...
                            <div class="tf-content-brands">
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/prada-logo.png')}}" alt="">
                                    </a>
                                    <a href="shop-default.html">Parda</a>
                                </div>
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/patek-philippe.png')}}" alt="">
                                    </a>
                                    <a href="shop-default.html">Patek philippe</a>
                                </div>
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/patagonia-logo.png')}}" alt="">
                                    </a>
                    ...
                    <div class="tf_filter_r tf-filter-item tf-tab-content">
                        <div class="tf-filter-item-inner">
                            ...
                            <div class="tf-content-brands">
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/ray-ban-logo.png')}}" alt="">
                                    </a>
                                    <a href="shop-default.html">Ray Ban</a>
                                </div>
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/roberto-cavalli-logo.png')}}" alt="">
                                    </a>
                    ...
                    <div class="tf_filter_s tf-filter-item tf-tab-content">
                        <div class="tf-filter-item-inner">
                            ...
                            <div class="tf-content-brands">
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/steve-madden-logo.png')}}" alt="">
                                    </a>
                    ...
                    <div class="tf_filter_t tf-filter-item tf-tab-content">
                        <div class="tf-filter-item-inner">
                            ...
                            <div class="tf-content-brands">
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/topshop-1-logo-png.png')}}" alt="">
                                    </a>
                                    <a href="shop-default.html">Topshop</a>
                                </div>
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/the-north-face-1-logo.png')}}" alt="">
                                    </a>
                                    <a href="shop-default.html">The North Face</a>
                                </div>
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/ted-baker-logo-png.png')}}" alt="">
                                    </a>
                    ...
                    <div class="tf_filter_v tf-filter-item tf-tab-content">
                        <div class="tf-filter-item-inner">
                            ...
                            <div class="tf-content-brands">
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/valentino-logo-png.png')}}" alt="">
                                    </a>
                    ...
                    <div class="tf_filter_z tf-filter-item tf-tab-content">
                        <div class="tf-filter-item-inner">
                            ...
                            <div class="tf-content-brands">
                                <div class="tf-item-inner">
                                    <a href="shop-default.html">
                                        <img src="{{asset('/assets/images/brand/zara-1-logo-png.png')}}" alt="">
                                    </a>
