                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 col-12">
                        <div class="footer-infor">
                            ...
                            <ul>
                                <li>
                                    <p>{{$allSettings['address']}}<br>{{$allSettings['city']}}</p>
                                </li>
                                <li>
                                    <p>Email: <a href="#">{{$allSettings['email']}}</a></p>
                                </li>
                                <li>
                                    <p>Phone: <a href="#">{{$allSettings['phone']}}</a></p>
                                </li>
                            </ul>
                            <a href="contact-1.html" class="tf-btn btn-line">Get direction<i class="icon icon-arrow1-top-left"></i></a>
                            <ul class="tf-social-icon d-flex gap-10">
                                @foreach ($allSettings as $key => $value)
                                <li><a href="{{$value}}" class="box-icon w_34 round {{$value}}"><i class="icon fs-14 icon-{{$key=='facebook' ? 'fb': $key}}"></i></a></li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
            ...
            <div class="mega-menu">
                <div class="row-demo">
                    ...
                    <div class="demo-item">
                        <a href="home-06.html">
                            <div class="demo-image position-relative">
                                <img class="lazyload" data-src="{{asset('/assets/images/demo/home-06.jpg')}}" src="{{'/assets/images/demo/home-06.jpg'}}" alt="home-06">
                                <div class="demo-label">
                                    <span class="demo-new">New</span>
                                </div>
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-07.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{asset('/assets/images/demo/home-07.jpg')}}" src="{{asset('/images/demo/home-07.jpg')}}" alt="home-07">
                            </div>
...
<!-- Mirrored from themesflat.co/html/ecomus/blog-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 04 Nov 2024 11:30:13 GMT -->
</html>
